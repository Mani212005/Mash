...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_conversation_states_chat_id", "conversation_states", ["chat_id"], unique=False
    )
    op.create_index(
        "ix_conversation_states_channel", "conversation_states", ["channel"], unique=False
    )
    op.create_index(
        "ix_conversation_states_namespace", "conversation_states", ["namespace"], unique=False
    )
    op.create_index(
        "ix_conversation_states_chat_namespace",
        "conversation_states",
        ["chat_id", "namespace"],
        unique=True,
    )
